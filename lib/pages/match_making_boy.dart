...
class MatchMakingBoy extends StatefulWidget {
  const MatchMakingBoy({Key? key}) : super(key: key);

  @override
  State<StatefulWidget> createState() => _MatchMakingBoyState();
}
            ...
            children: [
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    const Center(child: Text("Boy’s Details",style: TextStyle(fontSize: 20,fontWeight: FontWeight.w600),)),
                  ...
                  MediaQuery.of(context).size.width * 0.24,
                    ...
                    Navigator.pushNamed(context, "/matchmakinggirl");
                      },)
